import { r as AGENT_FEE_VAULT_USDC } from "./constants-BJEdPgzX.mjs";
import { t as create } from "../_libs/zustand.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/vault-store-DRZ_J-J6.js
...
function liveDemoState() {
	...
	const agentBal = state.wallets.get("0xA6E1700000000000000000000000000000000A6E") ?? {
		t0: 0n,
		t1: 0n
	};
	state.wallets.set(DEMO_AGENT, {
		t0: agentBal.t0 + 1000n * 1000000n,
		t1: agentBal.t1 + 1000n * 1000000n
	});
	return state;
}
