import { C as formatToken, D as shortAddr, O as timeAgo, w as formatUsdc, y as cn } from "./format-BlK3yrc5.mjs";
import { c as require_jsx_runtime } from "../_libs/@react-three/fiber+[...].mjs";
import { y as Link } from "../_libs/@tanstack/react-router+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/tape-BzzpMNrS.js
...
function Tape({ trades, engine, symbol, showMarket }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "overflow-x-auto rounded-[20px] border border-ink/8 dark:border-paper/10",
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							className: cn("px-3 py-2 capitalize", t.side === "sell" ? "text-danger" : isBuy || buyish ? "text-teal-2" : "text-muted"),
							children: t.side === "swap" ? "uniswap" : t.side
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
