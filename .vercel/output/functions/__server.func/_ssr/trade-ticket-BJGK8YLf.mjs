...
import { T as WAD, d as DEFAULT_SLIPPAGE_BPS, i as AMM_FEE_BPS, u as DEAD } from "./constants-BJEdPgzX.mjs";
import { i as require_react, r as require_jsx_runtime } from "../_libs/react+tanstack__react-query.mjs";
import { C as tokenBalance, E as useLaunchpad, S as sqrtPriceX96, b as sourceBalance, c as isArc, d as minOut, f as openOrders, h as previewSell, i as chainByDomain, l as ladder, m as previewBuy, n as LaunchError, p as poolK, r as bookMid, t as CCTP_CHAINS, x as spreadBps } from "./store-DuP6GcAD.mjs";
import { _ as parseUnits, c as formatUsdc, d as toInput, f as GlassPanel, h as cn, i as errorCopy, l as impactLabel, o as formatPriceWad, s as formatToken, v as shortAddr } from "./router-DnRFdBgV.mjs";
import { t as ClayButton } from "./clay-button-16tkSY36.mjs";
import { i as http, t as createPublicClient } from "../_libs/viem.mjs";
import { n as arcTestnet, t as ARC_TESTNET_DEPLOYMENT } from "./wagmi-OCoCqeUz.mjs";
import { t as fetchOnchainLaunches } from "./onchain-launches-9paTVvBN.mjs";
import { n as UsdcMark, t as ArcMark } from "./arc-mark-CtphBApM.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { n as useLiveTrade } from "./live-trade-sv1NEhax.mjs";
import { a as ResponsiveContainer, i as Area, n as YAxis, o as Tooltip, r as XAxis, t as AreaChart } from "../_libs/recharts+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/trade-ticket-BJGK8YLf.js
...
function TradeTicket({ launch }) {
	...
	const venue = !graduated ? "Bonding curve · 1.5%" : mode === "limit" ? "On-chain book · rest" : "Book, then Uniswap";
	const impact = quote && "impactBps" in quote ? quote.impactBps : 0;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(GlassPanel, {
		className: "p-5",
		children: [
			graduated ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mb-4",
			...
			mode === "limit" && graduated ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ClayButton, {
						...
						children: [busy ? "Confirm in wallet…" : preferLive && walletLive && mode === "market" && /^\d+$/.test(live.id) ? `${side === "buy" ? "Buy" : "Sell"} on Arc · ${live.symbol}` : mode === "limit" ? `Post ${side}` : side === "buy" ? `Buy ${live.symbol}` : `Sell ${live.symbol}`, !busy && graduated && mode === "market" ? " · book+AMM" : ""]
					}),
