...
import { E as useLaunchpad, a as graduateProgress, g as priceOf, u as marketCap, v as protocolStats } from "./store-DuP6GcAD.mjs";
import { y as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { d as RefreshCw, o as Star } from "../_libs/lucide-react.mjs";
import { a as formatCompact, c as formatUsdc, h as cn, o as formatPriceWad } from "./router-DnRFdBgV.mjs";
...
import { i as isLiveFactory, n as arcTestnet, t as ARC_TESTNET_DEPLOYMENT } from "./wagmi-OCoCqeUz.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/app-CQ98MGNo.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [graduated ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "font-mono text-[11px] text-teal-2",
					children: "LP locked · book live"
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					className: `min-h-9 rounded-full px-3 text-xs font-medium ${sourceFilter === id ? "bg-ink text-paper dark:bg-paper dark:text-ink" : "bg-ink/5 text-muted dark:bg-paper/10"}`,
					children: label
				}, id))
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						...
						children: [
							...
							". Numeric ids are on-chain; seeded demo markets stay local until you trade them in preview."
						]
					})
				]
			}),
